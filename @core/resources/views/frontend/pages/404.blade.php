        ...
        <div id="notfound">
            ...
            @endphp
                <div class="notfound-404">
                    <h1>{{__(get_static_option('error_404_page_'.$default_lang->slug.'_title'))}}</h1>
                </div>
                <h2>{{__(get_static_option('error_404_page_'.$default_lang->slug.'_subtitle'))}}</h2>
                <p>{{__(get_static_option('error_404_page_'.$default_lang->slug.'_paragraph'))}}</p>
                <a href="{{route('homepage')}}">{{__(get_static_option('error_404_page_'.$default_lang->slug.'_button_text'))}}</a>
            </div>
        </div>
    </body>
</html>

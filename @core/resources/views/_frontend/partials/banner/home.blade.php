...
$title = 'HKSC';
$subtitle = 'Welcome to';
$text = 'In 1961, The Federation of Hong Kong Industries created the Freight Joint Committee which lead to the creation of the Hong Kong Shippers’ Council in 1967 and became a government-subvented organisation in 1976.';
$delay = 9000;
if($page_setting){
...
<div class="banner banner-home">
                    ...
                    <div id="rev_slider_279_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="restaurant-header" style="margin:0px auto;background-color:#fff;padding:0px;margin-top:0px;margin-bottom:0px;">
                        ...
                        <div class="a-slider-title a-home  col-md-6">
                            ...
                            <div class="slider-text text-white">
                                ...
                                <a class="btn btn-primary has-radius-small" href="{{route('frontend.page',['type'=>'council-background'])}}">{{__('Learn More')}}</a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="table-wrap table-responsive">
                                        ...
                                        @foreach($category as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <x-delete-popover :url="route('admin.post.category.delete',$data->id)"/>
                                                    <a href="#"
                                                       data-toggle="modal"
            ...
            <div class="col-lg-5 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.post.category.new',['type'=>$type])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  id="seq_no" name="seq_no" placeholder="{{__('Seq No.')}}">
                            </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.post.category.update')}}"  method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_seq_no">{{__('Seq No.')}}</label>
                            <input type="text" class="form-control"  id="edit_seq_no" name="seq_no" placeholder="{{__('Seq No.')}}">
                        </div>
        ...
        $(document).ready(function () {
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "{{route('admin.post.category.bulk.action')}}",
                        'data' : {
                            _token: "{{csrf_token()}}",
                            ids: allIds
                        },
            ...
            $(document).on('click','.category_edit_btn',function(){
                ...
                modal.find('#edit_seq_no').val(seq_no);

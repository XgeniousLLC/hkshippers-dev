<div class="row">
    <div class="col-lg-8">
        ...
        <div class="form-group">
            ...
            <textarea type="text" class="form-control" name="title" placeholder="{{__('Title')}}">{{old('title')}}</textarea>
        </div>
        
        <div class="form-group">
            <label for="content">{{__('Content URL')}}</label>
            <input type="url" class="form-control" id="content" name="post_content" value="{{old('post_content')}}" placeholder="https://example.com">
        </div>

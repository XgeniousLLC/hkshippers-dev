                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{-- iFrameFilterInSummernoteAndRender($post->brief) --}}
                                        <textarea class="form-control d-none" name="brief" >{{$post->brief}}</textarea>
                                        <div class="summernote" data-content='{{iFrameFilterInSummernoteAndRender($post->brief)}}'></div>
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <label for="author">{{__('Image Name')}}</label>

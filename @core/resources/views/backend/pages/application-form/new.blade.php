                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            ...
                            <a href="{{route('admin.application-form',['type'=>$type])}}" class="btn btn-primary">{{__('All Items')}}</a>
                        </div>

                        <form action="{{route('admin.application-form.new',['type'=>$type])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('POST')

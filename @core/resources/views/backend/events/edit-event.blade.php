                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            ...
                            <a href="{{route('admin.events.all',['type'=>$event->type])}}" class="btn btn-primary">{{__('All items')}}</a>
                        </div>
...
@section('script')
    ...
    <x-backend.auto-slug-js :url="route('admin.events.slug.check')" :type="'update'"/>
    <script>

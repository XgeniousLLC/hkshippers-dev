    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click','.testimonial_edit_btn',function(){
                ...
                if(imageid != ''){
                    var img = '<img class="avatar user-thumb" src="'+image+'" >';
                    if(!/\.(jpg|jpeg|png|gif)$/.test(image)){
                        img = '<i class="fas fa-file file-icon"></i>';
                    }
                    form.find('.media-upload-btn-wrapper .img-wrap').html('<div class="attachment-preview"><div class="thumbnail"><div class="centered">'+img+' </div></div></div>');

                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.general.smtp.settings')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="site_email_cc">{{__('CC')}}</label>
                                <textarea type="text" name="site_email_cc"  class="form-control" id="site_email_cc">{{get_static_option('site_email_cc')}}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="site_smtp_mail_port">{{__('SMTP Mail Port')}}</label>
                                 <select name="site_smtp_mail_port" class="form-control">
                                    ...
                                    <option value="2025" @if(get_static_option('site_smtp_mail_port') == '2025') selected @endif>{{__('2025')}}</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="site_smtp_mail_encryption">{{__('SMTP Mail Encryption')}}</label>
                                 <select name="site_smtp_mail_encryption" class="form-control">
                                    <option value="null" @if(get_static_option('site_smtp_mail_encryption') == 'null') selected @endif>{{__('None')}}</option>

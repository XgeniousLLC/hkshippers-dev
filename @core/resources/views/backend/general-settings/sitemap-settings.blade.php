            ...
            <div class="col-12 mt-5">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.general.sitemap.settings')}}" id="sitemap_form" method="post" enctype="multipart/form-data">
                            @csrf
                                @php
                                    $url = url('/');
                                @endphp
                            ...
                            @foreach($all_sitemap as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{asset('assets/sitemap')}}/{{basename($data)}}" download class="btn btn-primary btn-xs mb-3 mr-1"> <i class="fa fa-download"></i> </a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>

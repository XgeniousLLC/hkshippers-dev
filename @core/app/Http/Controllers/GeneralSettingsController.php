...
class GeneralSettingsController extends Controller
{
    ...
    public function update_smtp_settings(Request $request)
    {
        ...
        update_static_option('site_email_cc', $request->site_email_cc);
    ...
    public function update_license_settings(Request $request)
    {
        ...
        $type = "danger";
        $msg = $result["message"] ?? __("could not able to verify your license key, please try after sometime, if you still face this issue, contact support");
    ...
    public function update_payment_settings(Request $request)
    {
        ...
        $env_val['FLW_SECRET_KEY'] = $request->flw_secret_key ?: 'YOUR_FLUTTERWAVE_SECRET_KEY';
        ...
        $env_val['STRIPE_SECRET_KEY'] = $request->stripe_secret_key ? : 'YOUR_STRIPE_SECRET_KEY';
    ...
    {
        $all_sitemap = glob('assets/sitemap/*');
    ...
    public function update_sitemap_settings(Request $request)
    {
        ...
        SitemapGenerator::create($request->site_url)
            ...
            ->writeToFile('assets/sitemap/sitemap-' . $title . '.xml');
        return redirect()->back()->with([

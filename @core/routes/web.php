...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode', 'HtmlMinifier']], function () {
    ...
    $post_page_slug = get_static_option('post_page_slug') ?? 'post';
    ...
    ---------------------------------------*/
    Route::get($post_page_slug, 'FrontendController@post_page')->name('frontend.post');
    Route::get( $post_page_slug.'/{slug}', 'FrontendController@post_single_page')->name('frontend.post.single');
    Route::get( $post_page_slug.'-search', 'FrontendController@post_search_page')->name('frontend.post.search');
    Route::get( $post_page_slug.'-category/{id}/{any}', 'FrontendController@category_wise_post_page')->name('frontend.post.category');
    Route::get( $post_page_slug.'-tags/{name}', 'FrontendController@tags_wise_post_page')->name('frontend.post.tags.page');

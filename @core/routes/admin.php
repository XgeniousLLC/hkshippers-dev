...
Route::prefix('admin-home')->middleware(['setlang:backend'])->group(function () {
 ...
 ==============================================*/
    ...
    /*==============================================
       Post
    ==============================================*/
    Route::prefix('post')->middleware(['adminPermissionCheck:Blogs Manage'])->group(function () {
        /*-------------------------
          Post
        --------------------------*/

        Route::get('/{type}', 'PostController@index')->name('admin.post');
        Route::get('/{type}/new', 'PostController@new_post')->name('admin.post.new');
        Route::post('/{type}/new', 'PostController@store_new_post');
        Route::post('/clone', 'PostController@clone_post')->name('admin.post.clone');
        Route::get('/edit/{id}', 'PostController@edit_post')->name('admin.post.edit');
        Route::post('/update/{id}', 'PostController@update_post')->name('admin.post.update');
        Route::post('/delete/{id}', 'PostController@delete_post')->name('admin.post.delete');
        Route::post('/bulk-action', 'PostController@bulk_action')->name('admin.post.bulk.action');
        Route::post('/slug-check', 'PostController@slug_check')->name('admin.post.slug.check');
        Route::post('/post-lang-by-cat/{type}', 'PostController@Language_by_slug')->name('admin.post.lang.cat');
        ...
        --------------------------*/
        Route::group(['prefix' => 'category'],function (){
            Route::get('/{type}', 'PostController@category')->name('admin.post.category');
            Route::post('/{type}/new', 'PostController@new_category')->name('admin.post.category.new');
            Route::post('/delete/{id}', 'PostController@delete_category')->name('admin.post.category.delete');
            Route::post('/update', 'PostController@update_category')->name('admin.post.category.update');
            Route::post('/bulk-action', 'PostController@category_bulk_action')->name('admin.post.category.bulk.action');
        });
    });
    /*==============================================
       Member
    ==============================================*/
    Route::prefix('member')->middleware(['adminPermissionCheck:Blogs Manage'])->group(function () {
        /*-------------------------
          Member
        --------------------------*/

        Route::get('/{type}', 'MemberController@index')->name('admin.member');
        Route::get('/{type}/new', 'MemberController@new')->name('admin.member.new');
        Route::post('/{type}/new', 'MemberController@store_new');
        Route::post('/clone', 'MemberController@clone')->name('admin.member.clone');
        ...
        Route::post('/delete/{id}', 'MemberController@delete')->name('admin.member.delete');
        Route::post('/bulk-action', 'MemberController@bulk_action')->name('admin.member.bulk.action');
        Route::post('/post-lang-by-cat', 'MemberController@Language_by_slug')->name('admin.member.lang.cat');
    ...
    /*==============================================
       Application Form
    ==============================================*/
    Route::prefix('application-form')->middleware(['adminPermissionCheck:Blogs Manage'])->group(function () {
        /*-------------------------
        Application Form
        --------------------------*/

        Route::get('/{type}', 'ApplicationFormController@index')->name('admin.application-form');
        Route::get('/{type}/new', 'ApplicationFormController@new')->name('admin.application-form.new');
        Route::post('/{type}/new', 'ApplicationFormController@store_new');
        Route::post('/clone', 'ApplicationFormController@clone')->name('admin.application-form.clone');
        Route::get('/edit/{id}', 'ApplicationFormController@edit')->name('admin.application-form.edit');
        Route::post('/update/{id}', 'ApplicationFormController@update')->name('admin.application-form.update');
        Route::post('/delete/{id}', 'ApplicationFormController@delete')->name('admin.application-form.delete');
        Route::post('/bulk-action', 'ApplicationFormController@bulk_action')->name('admin.application-form.bulk.action');
     ...
     /*==============================================
       Application Form
    ==============================================*/
    Route::prefix('media-room')->middleware(['adminPermissionCheck:Blogs Manage'])->group(function () {
        /*-------------------------
        Application Form
        --------------------------*/

        Route::get('/', 'MediaUploadController@index')->name('admin.media-room');
        Route::get('/new', 'MediaUploadController@new')->name('admin.media-room.new');
        Route::post('/new', 'MediaUploadController@store_new');
        Route::post('/clone', 'MediaUploadController@clone')->name('admin.media-room.clone');
        Route::get('/edit/{id}', 'MediaUploadController@edit')->name('admin.media-room.edit');
        Route::post('/update', 'MediaUploadController@update')->name('admin.media-room.update');
        Route::post('/delete/{id}', 'MediaUploadController@delete')->name('admin.media-room.delete');
        Route::post('/bulk-action', 'MediaUploadController@bulk_action')->name('admin.media-room.bulk.action');
...
==============================================*/
    ...
    Route::prefix('events')->middleware(['adminPermissionCheck:Events Manage', 'moduleCheck:events_module_status' ])->group(function () {
        ...
        /*----------------------------------------
            EVENTS MODULE: ROUTEs
        ----------------------------------------*/
        Route::get('/{type}/all', 'EventsController@all_events')->name('admin.events.all');
        Route::get('/{type}/new', 'EventsController@new_event')->name('admin.events.new');
        Route::post('/{type}/new', 'EventsController@store_event');
...
Route::prefix('admin-home')->group(function () {
    Route::post('/media-upload/type/{filetype}', 'MediaUploadController@get_upload_media_file')->name('admin.upload.media.file.filetype');
    ...
    Route::post('/media-upload/loadmore', 'MediaUploadController@get_media_for_loadmore')->name('admin.upload.media.file.loadmore');
    Route::post('/media-upload/loadmore/{filetype}', 'MediaUploadController@get_media_for_loadmore_filetype')->name('admin.upload.media.file.loadmore.filetype');
    /*--------------------------
        PAGE BUILDER
    --------------------------*/
